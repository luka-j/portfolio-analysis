...
- FORMATTING: Always use standard markdown lists (e.g., "- " or "* ") for bullet points. Never use plain bullet characters ("•"). Use appropriate whitespace (blank lines) before lists to ensure they render correctly.
</constraints>`

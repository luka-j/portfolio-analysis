    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <input
            autoFocus
            className="w-full bg-[#0f1117] border border-[#2a2e42] rounded-xl px-4 py-2.5 text-slate-100 font-mono text-sm focus:outline-none focus:border-indigo-500/50 mb-4"
            value={value}
